...
# Date:   octubre 2019
# Coms:   script de comprobaci�n de entrega de la pr�ctica 3 de PSCD (18/19)
#         Funcionamiento: 
#          1) Dar permisos de ejecuci�n al script: "chmod u+x pract3_correcta.bash"
#          2) Ejecutar mediante "pract3correcta.bash miNip" en el directorio donde est� el zip
#             a entregar, en este caso "practica3_miNip.zip". Crear� un directorio temporal
#             donde descomprimir� el zip, comprobar� si est�n los ficheros que tienen que estar
...
FICHEROS=(ConcurrentBoundedQueue/ConcurrentBoundedQueue.cpp \
	      ...
	      informe_p3.pdf)
DIRECTORIOS=(ConcurrentBoundedQueue BoundedQueue librerias/Logger_V2 librerias/Semaphore_V4)
...
if [[ "$#" -ne 1 ]]
then
	echo "Invocar como: pract3_correcta.sh miNip"
	echo "------------------------------------------"
	exit
fi
#----------------------------------------------------------------
